...
req = urllib.request.Request('http://127.0.0.1:8000/api/v1/embed', data=json.dumps({'text': 'Constitution of India Article 11'}).encode('utf-8'), headers={'Content-Type': 'application/json'})
